...
class ABtestDistributor:
    ...
    def split_users(self, model_a, model_b, split=0.3, n_clusters=2):
        ...
        self.user_list['userId'] = self.data_uploader.df_ratings['userId'].unique()
    ...
    def calculate_user_features(self):
        ...
        self.user_list['total_rating_count'] = self.data_uploader.df_ratings.groupby('userId')['rating'].count()
        self.user_list['total_rating_sum'] = self.data_uploader.df_ratings.groupby('userId')['rating'].sum()
